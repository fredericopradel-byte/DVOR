...
function init(){
 ...
 const nav=document.querySelector('.page-nav,.tabs nav');if(document.querySelector('.bottom-nav')||nav)document.body.classList.add('iv-has-bottom-nav');if(!nav)return;nav.classList.add('iv-bottom-nav');if(nav.parentElement.classList.contains('tabs')){const footer=nav.parentElement;document.body.append(nav);footer.hidden=true;document.body.classList.add('iv-legacy-nav')}
